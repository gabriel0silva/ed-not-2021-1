...
function bobbleSort(vetor, fnComp) {
    ...
    do {
        ...
        // Percusrso do vetor, da primeira até a PENÚLTIMA posição
...
bobbleSort(candidatos, (obj1, obj2) => obj1.NM_URNA_CANDIDATO > obj2.NM_URNA_CANDIDATO)
